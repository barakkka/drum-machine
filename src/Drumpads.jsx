...
function Drumpads({ passToParent, passElements, newAudioType, muted }) {
  ...
  const kitsArr = [
    {
      pianoName: "Chord_1",
      pianoLink: "/Piano/Chord_1.mp3",
      heaterName: "heater_1",
      heaterLink: "/Heater/Heater-1.mp3",
      letter: "Q",
      click: "One",
    },
    {
      pianoName: "Chord_2",
      pianoLink: "/Piano/Chord_2.mp3",
      heaterName: "heater_2",
      heaterLink: "/Heater/Heater-2.mp3",
      letter: "W",
      click: "Two",
    },
    {
      pianoName: "Chord_3",
      pianoLink: "/Piano/Chord_3.mp3",
      heaterName: "heater_3",
      heaterLink: "/Heater/Heater-3.mp3",
      letter: "E",
      click: "Three",
    },
    {
      pianoName: "Shaker",
      pianoLink: "/Piano/Give_us_a_light.mp3",
      heaterName: "heater_4",
      heaterLink: "/Heater/Heater-4_1.mp3",
      letter: "A",
      click: "Four",
    },
    {
      pianoName: "Open_HH",
      pianoLink: "/Piano/Dry_Ohh.mp3",
      heaterName: "clap",
      heaterLink: "/Heater/Heater-6.mp3",
      letter: "S",
      click: "Five",
    },
    {
      pianoName: "Closed_HH",
      pianoLink: "/Piano/Bld_H1.mp3",
      heaterName: "Open_HH",
      heaterLink: "/Heater/Dsc_Oh.mp3",
      letter: "D",
      click: "Six",
    },
    {
      pianoName: "Punchy_Kick",
      pianoLink: "/Piano/punchy_kick_1.mp3",
      heaterName: "Kick_n'_Hat",
      heaterLink: "/Heater/Kick_n_Hat.mp3",
      letter: "Z",
      click: "Seven",
    },
    {
      pianoName: "Side_Stick",
      pianoLink: "/Piano/side_stick_1.mp3",
      heaterName: "Kick",
      heaterLink: "/Heater/RP4_KICK_1.mp3",
      letter: "X",
      click: "Eight",
    },
    {
      pianoName: "Snare",
      pianoLink: "/Piano/Brk_Snr.mp3",
      heaterName: "Closed_HH",
      heaterLink: "/Heater/Cev_H2.mp3",
      letter: "C",
      click: "Nine",
    },
  ];
