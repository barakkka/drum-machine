...
function Drumpads({ passToParent, passElements, newAudioType, muted }) {
  ...
  const kitsArr = [
    ...
    {
      pianoName: "Chord_2",
      pianoLink: "/drum-machine/Piano/Chord_2.mp3",
      heaterName: "heater_2",
      heaterLink: "/drum-machine/Heater/Heater-2.mp3",
      letter: "W",
      click: "Two",
    },
    {
      pianoName: "Chord_3",
      pianoLink: "/drum-machine/Piano/Chord_3.mp3",
      heaterName: "heater_3",
      heaterLink: "/drum-machine/Heater/Heater-3.mp3",
      letter: "E",
      click: "Three",
    },
    {
      pianoName: "Shaker",
      pianoLink: "/drum-machine/Piano/Give_us_a_light.mp3",
      heaterName: "heater_4",
      heaterLink: "/drum-machine/Heater/Heater-4_1.mp3",
      letter: "A",
      click: "Four",
    },
    {
      pianoName: "Open_HH",
      pianoLink: "/drum-machine/Piano/Dry_Ohh.mp3",
      heaterName: "clap",
      heaterLink: "/drum-machine/Heater/Heater-6.mp3",
      letter: "S",
      click: "Five",
    },
    {
      pianoName: "Closed_HH",
      pianoLink: "/drum-machine/Piano/Bld_H1.mp3",
      heaterName: "Open_HH",
      heaterLink: "/drum-machine/Heater/Dsc_Oh.mp3",
      letter: "D",
      click: "Six",
    },
    {
      pianoName: "Punchy_Kick",
      pianoLink: "/drum-machine/Piano/punchy_kick_1.mp3",
      heaterName: "Kick_n'_Hat",
      heaterLink: "/drum-machine/Heater/Kick_n_Hat.mp3",
      letter: "Z",
      click: "Seven",
    },
    {
      pianoName: "Side_Stick",
      pianoLink: "/drum-machine/Piano/side_stick_1.mp3",
      heaterName: "Kick",
      heaterLink: "/drum-machine/Heater/RP4_KICK_1.mp3",
      letter: "X",
      click: "Eight",
    },
    {
      pianoName: "Snare",
      pianoLink: "/drum-machine/Piano/Brk_Snr.mp3",
      heaterName: "Closed_HH",
      heaterLink: "/drum-machine/Heater/Cev_H2.mp3",
      letter: "C",
      click: "Nine",
    },
  ];
